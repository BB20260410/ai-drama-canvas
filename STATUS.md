...
| earliest_next | A 仍等 owner。B earliest / 驾驶舱 nextAction 已按节点状态区分 dispatch/wait/retry/Review（不执行、不派发、不重试）。真实验证需正式工程。禁止写「运行速度已关账」/「100% 契合」/「角色/场景/道具/扩写格/节拍/风格锁已完全解决」 |
