...
| B_earliest | earliest / 驾驶舱 / SSL-5 / 对照 / session-snapshot / 生成控制 / pack envelope / readiness / 画布节点 / active-runs / plan / history 信封 next 已按 wait/retry/Review 对齐；15s 向导物化后下一步含 create-plan；session-snapshot 与 history 信封一致性四态 peek 已接；真生图约束验证仍等 owner |
