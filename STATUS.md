...
| earliest_next | A 仍等 owner。B 生成控制 / pack envelope 已接 unit-grid create-plan 只读草稿（只认已落盘 history/计划 pack，不用 readiness 候选；不执行、不 dispatch）。真实验证需正式工程。禁止写「运行速度已关账」/「100% 契合」/「角色/场景/道具/扩写格/节拍已完全解决」 |
