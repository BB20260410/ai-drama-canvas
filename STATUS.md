...
| earliest_next | A 仍等 owner。B 单镜 Agent brief 已带 shotTypeLine / beatLine（只从冻结包；不改 renderedPrompt）。真实验证需正式工程。禁止写「运行速度已关账」/「100% 契合」/「角色/场景/道具/扩写格/节拍已完全解决」 |
