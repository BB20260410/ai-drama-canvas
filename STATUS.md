...
| external-review | 2026-08-26 分席实调：千问主审 **无 must-fix**；DeepSeek 虚构路径并误判红线保留；GLM 思考占满无合格表；豆包两次超时。未按 DeepSeek 去拆 ledger / 全量异步化 rebuildGraph。证据 `docs/evidence/runtime-perf-memory-external-review-20260826.json`。整计划仍部分完成 |
