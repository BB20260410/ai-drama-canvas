...
| earliest_next | A 仍等 owner。B earliest 只对一个 pending 单元按落盘 pack/计划区分 freeze/plan/dispatch（全槽位仍不读 pack；只读开库；不执行、不 dispatch）。真实验证需正式工程。禁止写「运行速度已关账」/「100% 契合」/「角色/场景/道具/扩写格/节拍已完全解决」 |
