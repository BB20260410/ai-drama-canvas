...
| earliest_next | A 仍等 owner。B 驾驶舱已落盘整板 pack 无计划时 nextAction 为 create-plan（readiness 候选不当冻结包；不执行、不 dispatch）。真实验证需正式工程。禁止写「运行速度已关账」/「100% 契合」/「角色/场景/道具/扩写格/节拍已完全解决」 |
