...
| earliest_next | A 仍等 owner。B SSL-5 create-plan 只读草稿已接（只认焦点缺图格 focusPackId；不执行、不 dispatch）。真实验证需正式工程。禁止写「运行速度已关账」/「100% 契合」/「角色/场景/道具/扩写格/节拍已完全解决」 |
