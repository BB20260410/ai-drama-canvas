...
| earliest_next | A 仍等 owner。B session-snapshot / 生成控制已接 create-plan 只读草稿（只认当前宫格已落盘单镜包；不执行、不 dispatch）。真实验证需正式工程。禁止写「运行速度已关账」/「100% 契合」/「角色/场景/道具/扩写格/节拍已完全解决」 |
