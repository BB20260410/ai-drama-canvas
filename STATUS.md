...
| 字段 | 当前值 |
|---|---|
| status | `部分完成`：W6 已停。§1 八条 1/2/7/8 已完成，3/4/5/6 部分完成。驾驶舱 bundle 已有界（当前+邻接）。未跑安装版 T23 / P7 owner / 列表探针。禁止写「运行速度已关账」 |
...
| evidence | `docs/evidence/runtime-perf-memory-wave1*.json`、`wave2*`（含 `wave2c`、`wave2-bundle-approved-bound`）、`wave3*`、`wave4a`–`wave4f`、`wave5a`–`wave5e`、`wave6a`–`wave6c` |
...
| earliest_next | 驾驶舱 bundle 有界已落地。开放残差：earliest/diagnostics 仍整集（需全序）；P7 owner / 安装版 T23 / 列表探针需 Darwin 或 owner。禁止 N124 / 禁止写「运行速度已关账」 |
