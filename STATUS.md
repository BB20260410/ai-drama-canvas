...
| B_earliest | unit-grid Agent brief.BEATS 已带起止秒与扩写/原镜；真生图约束验证仍等 owner |
...
| earliest_next | A 仍等 owner。B unit-grid Agent brief.BEATS 已带起止秒与扩写/原镜（不改冻结 renderedPrompt）。真实验证需正式工程。禁止写「运行速度已关账」/「100% 契合」/「角色/场景/道具/扩写格/节拍已完全解决」 |
