...
import {
  NOVEL_AGENT_CAPABILITIES,
  NOVEL_AGENT_CONTRACT_VERSION,
  NOVEL_AGENT_DEFAULT_CONTEXT_CHAPTERS,
  NOVEL_AGENT_DEFAULT_CONTEXT_CHARACTERS,
  NOVEL_AGENT_DEFAULT_READ_CHARACTERS,
  NOVEL_AGENT_MAX_CONTEXT_CHAPTERS,
  NOVEL_AGENT_MAX_CONTEXT_CHARACTERS,
  NOVEL_AGENT_MAX_CONTEXT_SEARCH_HITS,
  NOVEL_AGENT_MAX_READ_CHARACTERS,
} from "./novel-agent-capabilities.js";
