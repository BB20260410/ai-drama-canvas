...
.span-table { min-width: 760px; }.span-table > header,.span-row { display: grid; grid-template-columns: minmax(145px,.8fr) minmax(150px,.9fr) minmax(220px,1.35fr) minmax(150px,.8fr) 84px; align-items: center; gap: 14px; }.span-table > header { height: 36px; color: #5f6259; font-size: 7px; border-bottom: 1px solid #30322c; }.span-row { width: 100%; min-height: 72px; padding: 8px 0; border: 0; border-bottom: 1px solid #292b25; background: transparent; color: #d8d7d0; text-align: left; cursor: pointer; content-visibility: auto; contain-intrinsic-size: auto 72px; }.span-row:hover { background: #181916; }.span-row b,.span-row small { display: block; }.span-row b { font-size: 9px; }.span-row small { margin-top: 5px; color: #74776e; font-size: 7px; line-height: 1.45; }.assets-cell small:first-child { margin-top: 0; }.version-cell small { font-family: Menlo,monospace; }.open-cell { display: flex; align-items: center; justify-content: flex-end; gap: 5px; color: #d7af55; font-size: 8px; }
