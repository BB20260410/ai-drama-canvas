...
server.registerPrompt(
  ...
  async ({ projectRoot, provider, unitId, panelId }) => {
    ...
    return promptMessage([
      ...
      "9) get_studio_generation_control(history order=newest-first|call|detached-unknown|pack) 看 envelope nextAction 对账调用与结果身份；Review 时禁止再 dispatch，交给 Review/连续性门",
      "",
